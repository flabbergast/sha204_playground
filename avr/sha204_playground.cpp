...
volatile uint8_t idle = 0;
  ...
  // #define SHA204_POWER_UP {}  // use this if using actual GND and VCC supply
  #define SHA204_POWER_UP SHA204_GND_PORT.DIRSET = SHA204_GND_BIT; SHA204_GND_PORT.OUTCLR = SHA204_GND_BIT; SHA204_VCC_PORT.DIRSET = SHA204_VCC_BIT; SHA204_VCC_PORT.OUTSET = SHA204_VCC_BIT // use this if powering from PORT pins
#else // AVR8
  //  -> If you use actual GND and VCC pins for power, ignore the _VCC_ and _GND_ settings
  //     and redefine the S_POWER_UP macro to be blank
  ...
  // Choose the appropriate S_POWER_UP macro according to your power setup
  #define SHA204_POWER_UP {}  // use this if using actual GND and VCC supply
  // #define SHA204_POWER_UP SHA204_GND_DDR|=SHA204_GND_BIT; SHA204_GND_PORT&=~SHA204_GND_BIT; SHA204_VCC_DDR|=SHA204_VCC_BIT; SHA204_VCC_PORT|=SHA204_VCC_BIT;  // use this if powering from PORT pins
#endif
